    ...
    <section class="relative mt-30">
      ...
      >
        ...
        >
          <!-- FULLSCREEN SLIDE -->
          <div
            class="h-full w-full flex overflow-hidden bg-background-dark relative"
          >
            <!-- Background gradient specific to section -->
            <div
              class="absolute inset-0 pointer-events-none"
              [ngClass]="section.bgGradient"
            ></div>

            <!-- Left Column (Visual) -->
            <div
              class="w-1/2 h-full flex items-center justify-center p-8 lg:p-16 relative z-10"
            >
              @if (section.id === 'angular-3d') {
              <!-- 3D Scene Visual -->
              <div
                class="relative w-full aspect-square max-w-2xl rounded-2xl overflow-hidden border border-primary-500/20 bg-background-dark/50 backdrop-blur-sm"
              >
              ...
              <div
                class="relative w-full max-w-2xl aspect-square rounded-2xl overflow-hidden border border-primary-500/20 bg-background-dark/50 backdrop-blur-sm shadow-card p-8 flex flex-col justify-center"
              >
                <div class="space-y-8">
                  <!-- Scroll trigger demo -->
                  <div class="relative">
                    <div
                      class="text-body-sm font-mono text-primary-500/60 mb-2"
                    >
                    ...
                    <div class="flex gap-4 overflow-hidden">
                      ...
                      <div
                        class="w-16 h-16 rounded-xl bg-gradient-to-br from-primary-500 to-primary-600 shadow-lg animate-pulse"
                        [style.animation-delay.ms]="k * 200"
                      ></div>
                      }
                    </div>
                  </div>
                  ...
                  <div class="relative">
                    ...
                    <div
                      class="relative h-3 bg-gray-800 rounded-full overflow-hidden"
                    >
                      <div
                    ...
                    <div
                      class="flex justify-between mt-2 text-xs text-gray-400"
                    >
                      <span>0%</span><span>Section Progress</span
                      ><span>100%</span>
                    </div>
                  </div>
                  <!-- Code preview -->
                  <div
                    class="bg-background-dark rounded-xl p-6 border border-gray-800"
                  >
                    <div class="flex items-center gap-2 mb-4">
                      <div class="w-3 h-3 rounded-full bg-red-500"></div>
                      <div class="w-3 h-3 rounded-full bg-yellow-500"></div>
                      <div class="w-3 h-3 rounded-full bg-green-500"></div>
                      <span class="ml-4 text-xs text-gray-400 font-mono"
                        >component.html</span
                      >
                    </div>
                    <pre
                      class="text-neon-green font-mono text-xs overflow-x-auto"
                    ><code>&lt;div scrollAnimation [animationType]="'fadeInUp'"&gt; ... &lt;/div&gt;</code></pre>
                  </div>
                </div>
              </div>
              }
            ...
            <div
              class="w-1/2 h-full flex flex-col justify-center px-8 lg:px-16 lg:pr-24 relative z-10"
            >
              <!-- Package Badge -->
              <div class="flex items-center gap-3 mb-6">
                <span
                  class="px-3 py-1 bg-primary-500/20 border border-primary-500/40 rounded-full text-primary-400 text-sm font-mono"
                >
                  {{ section.package }}
                </span>
              </div>
              ...
              <!-- Headline -->
              <h2
                class="text-4xl lg:text-5xl font-bold text-white leading-tight mb-6"
                [innerHTML]="section.headline"
              ></h2>
              ...
              <div class="grid grid-cols-2 gap-3 mb-8">
                @for (capability of section.capabilities; track capability; let
                j = $index) {
                <div
              ...
              <!-- Metric Badge -->
              <div
                class="inline-flex items-center gap-4 px-6 py-4 bg-gradient-to-r from-primary-500/20 to-neon-green/20 rounded-xl border border-primary-500/30 mb-8 w-fit"
              >
                <div
                  class="text-3xl font-bold bg-gradient-to-br from-primary-400 to-neon-green bg-clip-text text-transparent"
                >
                  {{ section.metricValue }}
                </div>
                <div>
              ...
              <a
                ...
                class="inline-flex items-center gap-2 px-8 py-4 bg-neon-green text-background-dark rounded-button font-semibold hover:scale-105 hover:shadow-neon-green transition-all duration-250 w-fit"
              >
                {{ section.ctaText }}
                <svg
                  class="w-5 h-5"
